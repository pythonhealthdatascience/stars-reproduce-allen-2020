...
* **Best practice audit** - requirements from the best practice audit by Monks et al. 2023 @monks_computer_2023. The items in this audit were based on the Turing Way  @the_turing_way_community_turing_2022, Taylor et al. 2017 @taylor_open_2017, and the Open Modelling Foundation @the_open_modeling_foundation_omf_reusability_2024.
* **STARS** - recommendations from the recently published STARS framework by Monks et al. 2024. @monks_towards_2024.
...
| Link to published paper | Do models shared externally from journal articles contain a link to the published article? | ✅ Fully | Zenodo citations section includes link to the article |
